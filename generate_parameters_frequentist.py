...
def generate_retail_param():
    generate_job_params(directory='retail_benchmark/',
                         dataset_ind=2,
                        bayesian_flag=False,
                        mv_flag=False,
                        LS_flag=False,
...
def generate_alcohol_param():
    generate_job_params(directory='alcohol_benchmark/',
                         dataset_ind=0,
                        bayesian_flag=False,
                        mv_flag=False,
                        LS_flag=False,
    ...
    generate_job_params(directory='alcohol_bayesian_dual/',
                        dataset_ind=0,
                        bayesian_flag=False,
                        mv_flag=True,
                        LS_flag=False,
    ...
    generate_job_params(directory='alcohol_bayesian_dual_LS/',
                        dataset_ind=0,
                        bayesian_flag=False,
                        mv_flag=True,
                        LS_flag=True,
    ...
    generate_job_params(directory='alcohol_bayesian_primal/',
                        dataset_ind=0,
                        bayesian_flag=False,
                        mv_flag=False,
                        LS_flag=False,
    ...
    generate_job_params(directory='alcohol_bayesian_primal_LS/',
                        dataset_ind=0,
                        bayesian_flag=False,
                        mv_flag=False,
                        LS_flag=True,
...
def generate_movielens_params():
    generate_job_params(directory='movielens_20_benchmark/',
                         dataset_ind=1,
                        bayesian_flag=False,
                        mv_flag=False,
                        LS_flag=False,
    ...
    generate_job_params(directory='movielens_20_bayesian_dual/',
                         dataset_ind=1,
                        bayesian_flag=False,
                        mv_flag=True,
                        LS_flag=False,
    ...
    generate_job_params(directory='movielens_20_bayesian_dual_LS/',
                         dataset_ind=1,
                        bayesian_flag=False,
                        mv_flag=True,
                        LS_flag=True,
    ...
    generate_job_params(directory='movielens_20_bayesian_primal/',
                         dataset_ind=1,
                        bayesian_flag=False,
                        mv_flag=False,
                        LS_flag=False,
    ...
    generate_job_params(directory='movielens_20_bayesian_primal_LS/',
                         dataset_ind=1,
                        bayesian_flag=False,
                        mv_flag=False,
                        LS_flag=True,
...
if __name__ == '__main__':
    ...
    generate_alcohol_param()
    generate_movielens_params()
