...
if __name__ == '__main__': #forecasts tends to converge to constant value for some reason...
    ...
    base_dict = {
        ...
        'reg_para_b': 1.1, #regularization sets all params to 0? Does not work, figure out why...
        ...
        'latent_scale': False,
        'dual': True,
        'init_max': 1e-1*5, #fixes regularization issues... Trick for succesfull VI
        'bayesian': True,
        'multivariate': False,
        'mu_a': 0,
        'mu_b': 0,
        ...
        'lambda_T_x_a': 100.0,#625., for none kernel approach  TRAFFIC: 100-625, CCDS: 500 - 1000
        'lambda_T_x_b': 100.0+1e-4,#625.1, Try lower values actually for KFT! #Regularization term seems to blow up if "overtrained on entire set"
        'patience': 500,#100,
