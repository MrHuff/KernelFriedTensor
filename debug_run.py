...
if __name__ == '__main__':
    ...
    base_dict = {
        'PATH': PATH[dataset],
        'reg_para_a':10.0, #for VI dont screw this up
        'reg_para_b': 10.1, #regularization sets all params to 0? Does not work, figure out why...
        ...
        'lambda_T_x_b': 1.+1e-4,#625.1, Try lower values actually for KFT! #Regularization term seems to blow up if "overtrained on entire set"
        'patience': 500,#100,
        'periods':5,#7, 1
        'period_size':15,
